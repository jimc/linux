...
/*
 * Compare an uncompressed ASCII string against a compressed symbol table.
				 ...
				 unsigned int *end)
{
	...
	/*
	 * We found a match. There might be several symbols with the same
	 * name, so we expand the search to find the first and last matches.
	 */
	while (low) {
