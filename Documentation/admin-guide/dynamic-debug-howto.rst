...
class
    ...
    is accepted by a module, callsite & class matching and adjustment
    proceeds.  Examples::
...
DYNAMIC_DEBUG_CLASSMAP_PARAM_REF(name,bits,var,flags) - connects an
existing module parameter variable (e.g. __drm_debug) to a classmap.
