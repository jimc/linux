...
extern unsigned int ivpu_dbg_mask;
...
enum ivpu_dbg_category {
	/*
	 * since accels are drm-devices (CONFIG_DRM_ACCEL_*), their
	 * dyndbg-classmap must coexist with DRM_UT_*, ie we must
	 * avoid DRMs 0..10 class_id reservations.
	 */
	IVPU_DBG_REG = 16,
	IVPU_DBG_IRQ,
	IVPU_DBG_MMU,
